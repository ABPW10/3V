...
getB('https://api.tianditu.gov.cn/v2/administrative?keyword=台湾省&tk=bdbbba21b624d7f141c1f97c3d0fd7ef').then(r=>new Blob([new Uint8Array(r.content.data)], { type: r.contentType }).json()).then(j=>{
  const TWCities=[
...
const 西藏基本与增补=[
["达旺",[91.86891,27.591427],0],//རྟ་དབང་།
["德让宗",[92.272926,27.343827],0],//དི་རང་རྫོང་།
["邦迪拉",[92.422796,27.266657],0],//བུམ་ལྡིར་ལ།
["尼乌木",[94.151911,28.158634],0],
["哥里西娘",[93.476389,28.363333],0],//དགེ་ལི་ཤི་ཉའ།
["木比丁",[93.25,28.43],2],
["格刀",[95.01219,28.692245],0],//དགེ་སྟི།
["南英",[94.425,28.515],0],
["里戛",[95.040787,28.437294],0],//རི་ཀ
["巴昔卡",[95.325,28.075],0],//སྤ་ཞི་ཁ།
["瓦弄",[97.017725,28.129533],0],//ཝ་ལུང་།
["阿帕龙",[95.8428,28.437574],0],//ཨ་མི་གླིང་།
...
["查库",[[92,24,51],[27,6,8]],1],
["新炯",[[92,29,1],[27,11,56]],1],
...
L.vectorGrid.slicer(geoJsonData,{
    vectorTileLayerStyles: {
        sliced: function(p, z) {
          if(p.level==0&&z<8||p.level>0&&p.level<2&&z<9||p.level>=2&&z<11){return[]}
